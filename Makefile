...
pkgdatadir = $(datadir)/dchat-gui
pkgincludedir = $(includedir)/dchat-gui
pkglibdir = $(libdir)/dchat-gui
pkglibexecdir = $(libexecdir)/dchat-gui
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/config.h.in AUTHORS ChangeLog INSTALL NEWS README \
	TODO compile depcomp install-sh missing
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/m4/m4-ax_with_curses.m4 \
...
PACKAGE_NAME = dchat-gui
PACKAGE_STRING = dchat-gui 0.9
PACKAGE_TARNAME = dchat-gui
PACKAGE_URL = 
PACKAGE_VERSION = 0.9
PATH_SEPARATOR = :
SET_MAKE = 
